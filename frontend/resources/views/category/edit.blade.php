            ...
            <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
                <div class="max-w-md w-full space-y-8">
                        ...
                        <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg"
                            ...
                            <div class="text-center">
                                <div class="d-flex my-4">
                                    <h1 class="text-center text-green-300 text-[30px] font-bold">Edit Category</h1>
                                </div>
                    ...
                    <div class="rounded bg-white max-w-md rounded overflow-hidden shadow-xl p-5">
                        ...
                        <form class="mt-8 space-y-3" action="{{ route('category.update', $category['slug']) }}" method="POST"
                            ...
                            <div class="rounded-md shadow-sm -space-y-px">
                                <div class="grid gap-6">
                                    <div class="col-span-12">
                                        <label for="nama_category" class="block text-sm font-medium text-gray-700">Nama Category</label>
                                        <input type="text" name="nama_category" id="nama_category" autocomplete="given-name"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('nama_category', $category['nama_category']) }}">
                                    </div>
                                    @error('nama_category')
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <input type="text" name="slug" id="slug" autocomplete="given-name"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('slug', $category['slug']) }}">
                                    </div>
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <input type="text" name="deskripsi" id="deskripsi" autocomplete="given-name"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('deskripsi', $category['deskripsi']) }}">
                                    </div>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
