            ...
            <form class="mt-8 space-y-3" action="{{ route('book.update', $book[0]['id']) }}" method="POST"
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <input
                        ...
                        id="judul" autofocus value="{{ old('judul', $book[0]['judul']) }}">
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <select
                        ...
                        <option disabled @if (!old('category_id', $book[0]['category_id'])) selected @endif> -- select an option
                            -- </option>
                        @foreach ([1, 2, 3, 4, 5] as $category)
                            @if (old('category_id', $book[0]['category_id'] == $category))
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <select
                        ...
                        <option disabled @if (!old('author_id', $book[0]['author_id'])) selected @endif> -- select an option
                            -- </option>
                        @foreach ([1, 2, 3, 4, 5] as $author)
                            @if (old('author_id', $book[0]['author_id'] == $author))
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <input
                        ...
                        value="{{ old('penerbit', $book[0]['penerbit']) }}">
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <input
                        class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                        type="text" placeholder="Masukkan kota penerbitan buku"
                        @error('kota_penerbitan') is-invalid @enderror name="kota_penerbitan" id="kota_penerbitan" required
                        autofocus value="{{ old('kota_penerbitan', $book[0]['kota_penerbitan']) }}">
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <input
                        ...
                        id="ISBN" required autofocus value="{{ old('ISBN', $book[0]['ISBN']) }}">
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <input
                        ...
                        value="{{ old('tahun_terbit', $book[0]['tahun_terbit']) }}">
                        ...
                        <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                            <div class="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                                ...
                                <p class="pointer-none text-gray-500 "><span class="text-sm">Drag and drop</span> files here <br /> or
                                    <a id="" class="text-blue-600 hover:underline">select a file</a> from your computer</p>
                            </div>
